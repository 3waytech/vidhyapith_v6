            ...
            <div class="panel-body">
                <div class="row mb-lg">
                    <div class="col-md-3">
                        ...
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="header" value="true" checked=""><i></i> Header
                            </label>
                        </div>
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="footer" value="true" checked=""><i></i> Footer
                            </label>
                        </div>
                        <div class="checkbox-replace">
                            <label class="i-checks">
                                <input type="checkbox" name="landscape" value="true"><i></i> landscape
                            </label>
                        </div>
                        ...
                        <div class="checkbox-replace mt-xs">
                            <label class="i-checks">
                                <input type="checkbox" name="date" value="true" checked=""><i></i> Print Date
                            </label>
                        </div>
                        <div class="checkbox-replace mt-xs">
                            <label class="i-checks">
                                <input type="checkbox" name="parentsign" value="true" checked=""><i></i> Parent Sign
                            </label>
                        </div>
                        <div class="checkbox-replace mt-xs">
                            <label class="i-checks">
                                <input type="checkbox" name="gpa" value="true" checked=""><i></i> GPA
                            </label>
                        </div>
                        ...
                        <div class="form-group mt-xs" style="mrgin-left:100px;">
                            <label class="control-label"><?=translate('exam_name')?></label>
                            <input type="text" name="exam_name" class="form-control" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="col-md-3 mb-sm">
                        <div class="form-group">
							<h4>Exclude Mark Subject</h4>
						<label class="control-label"><?=translate('subject')?></label>
							<?php
								...
								// echo form_dropdown("subject_id", $arraySubject, set_value('subject_id'), "class='form-control' id='subject_id' multiple
								// data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
                                echo form_dropdown("subject_id[]", $arraySubject, set_value('subject_id'), "class='selectpicker' id='subject_id' multiple");
...
$(document).ready(function() {
    ...
    $('form.printIn').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                var html = data;
                if (<?php echo $landscape ? 'true' : 'false'; ?>) {
                    html = '<style>@media print{@page {size: landscape;}}</style>' + html;
                }
                // fn_printElem(html, true);
                fn_printElem(html,
                true); // Prints the content of an element with ID "element-id"
