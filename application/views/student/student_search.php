        ...
        <section class="panel">
                ...
                <div class="row mb-sm">
                    <div class="col-md-3 mb-sm">
                        <div class="form-group">
                            ...
                            <?php
                            $arrayClass = $this->app_lib->getcategory($branch_id);
                            echo form_dropdown("category_id", $arrayClass, set_value('category_name'), "class='form-control' id='category_id' 
                            data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
                        ?>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <div class="row mb-sm">
                    ...
                    <div class="col-md-3 mb-sm">
                        <div class="form-group">
                            <label class="control-label"><?=translate('phone_number')?></label>
                            ...
                            <td class="checked-area">
                                <div class="checkbox-replace">
                                    <label class="i-checks">
                                        <input type="checkbox" class="cb_bulkdelete"
                                            id="<?=$row['student_id']?>"><i></i>
                                    </label>
                                </div>
                            </td>
						...
						?>
                            ...
                            <td>
                                <div class="progress progress-xl m-none prb-mw">
                                    <div class="progress-bar text-dark" role="progressbar" aria-valuenow="60"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <?=$fee_progress?>%;">
                                        <?=$fee_progress?>%</div>
                                </div>
                            </td>
                            <td class="action">
                                ...
                                <!-- update link -->
                                <a href="<?php echo base_url('student/profile/' . $row['student_id']);?>"
                                    class="btn btn-default btn-circle icon" data-toggle="tooltip"
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="quick_image">
                <img alt="" class="user-img-circle" id="quick_image"
                    src="<?=base_url('uploads/app_image/defualt.png')?>" width="120" height="120">
            </div>
