	...
	<div class="col-md-12">
		<section class="panel">
			...
			<div class="panel-body">
					...
					<div class="col-md-<?= $widget ?> mb-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="joining_date" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true }' autocomplete="off" value="<?= set_value('joining_date') ?>" />
							</div>
				...
				<!-- <div class="col-md-4 mb-sm">
						<div class="form-group">
							<label class="control-label"><?php // translate('birthday') 
															?> </label>
							<div class="input-group">
								<span class="input-group-addon"><i class="fas fa-birthday-cake"></i></span>
								<input class="form-control" name="birthday" autocomplete="off" value="<?php // set_value('birthday') 
				...
				<div class="row">
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><i class="fas fa-birthday-cake"></i></span>
								<input class="form-control" name="birthday" autocomplete="off" value="<?= set_value('birthday') ?>" data-plugin-datepicker data-plugin-options='{ "startView": 2 }' type="text">
							</div>
						</div>
					</div>
					<!-- <div class="col-md-6 mb-sm">
					...
					<input class="form-control" name="mobile_no" type="hidden" value="<?= set_value('mobile_no') ?>" autocomplete="off" />
					<!-- </div>
